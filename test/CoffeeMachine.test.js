...
class CoffeeMachine {
  ...
  dispenseCoffee(size, sugar) {
    ...
    if (this.resources.cups <= 0) throw new Error('No hay vasos disponibles');
    if (this.resources.coffeeOz < cupSize) throw new Error('No hay suficiente café');
    if (this.resources.sugar < sugar) throw new Error('No hay suficiente azúcar');
